<template>
	<view>
		...
		<view style="padding: 30rpx;box-sizing: border-box;" v-if="!is_notopen">
			<u--form labelPosition="left" :model="add_form" ref="add_form_ref">
				<u-form-item label="分类" borderBottom @click="show_type = true;" prop="category_id">
				...
				<u--textarea placeholder="在这里创作您的信息, 请勿发布违反法律规定的内容哟,否则会被拉入黑名单的哟~" border="bottom" :height="160" count
					:maxlength="500" v-model="add_form.substance"></u--textarea>
				...
				<u-form-item label="联系方式" borderBottom labelWidth="80">
				...
				<u-form-item label="显示位置" borderBottom @click="select_community" prop="community_name" labelWidth="80" v-if="!add_form.is_hide_location">
					<u--input v-model="add_form.community_name" disabled disabledColor="#ffffff" placeholder="可选（不选择默认当前小区）"
						border="none"></u--input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
				<view
					style="height: 20px;line-height:20px;border-left: 5px solid #3C9CFF;margin-top: 35rpx;padding-left: 15rpx;margin-bottom: 30rpx;font-size: 14px;">
					实验性功能
				</view>
				<view style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
					<view style="font-size: 14px;">隐藏小区信息</view>
					<view>
						<u-switch v-model="add_form.is_hide_location" @change="is_hide_location_change" size="18"></u-switch>
					</view>
				</view>
				<view style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
					<view style="font-size: 14px;">仅自己小区可见</view>
					<view>
			...
			<view style="margin-top: 30rpx;">
				<u-button type="primary" text="立即发布" @click="submit()"></u-button>
			</view>
		</view>
