<template>
	<view style="background:#f3f4f6;position:absolute;top:0;left:0;right:0;bottom: 0;">
		...
		<view v-if="!is_notopen"> 
			<Xsuu-swiper :swiperItems="banner_list"></Xsuu-swiper>
			<view class="content">
				<view class="noticebar"
					style="padding: 0 30rpx; box-sizing: border-box;margin-bottom: 25rpx;">
					<u-notice-bar :text="notice_title" mode="link"></u-notice-bar>
				</view>
				<view
					style="background:#ffffff;padding-bottom:25rpx;margin:0 30rpx;border-radius:15rpx;box-sizing: border-box;">
				...
				<view
					style="background:#ffffff;margin:30rpx;border-radius:15rpx;">
					<view style="display: flex;justify-content: space-between;align-items: center">
						<u-tabs :list="tab_list" @click="tab_click" :current="information_form.seach_type"></u-tabs>
					</view>
				</view>
				
				<view style="background:#ffffff;margin:30rpx;border-radius:15rpx;padding: 30rpx;" v-if="page_loding == 'nomore' && $u.test.isEmpty(information_list)">
					<u-empty mode="news" icon="http://cdn.uviewui.com/uview/empty/news.png" text=" " style="margin-bottom: 25rpx;">
					</u-empty>
				</view>
